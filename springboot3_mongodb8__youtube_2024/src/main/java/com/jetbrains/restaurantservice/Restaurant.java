...
public class Restaurant {
    ...
    /**
     * In the real world, this might be more than one number
     * - e.g. indoor vs outdoor capacity; or capacity per area (e.g. the back room).
     */
    public int capacity;

    /**
     * Currently the restaurant only supports defining the days of the week it is open.
     * Ideally, this would be expanded to allow a restaurant to define opening hours
     * (potentially more than one set of hours a day) per day of the week.
