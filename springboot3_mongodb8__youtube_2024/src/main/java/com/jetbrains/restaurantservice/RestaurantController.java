...
public class RestaurantController {
     ...
     * @param id the ID of the restaurant you are updating.
     *           This will be used to locate and update the restaurant to be
     *           changed, NOT the ID in the updatedRestaurant object
     */
    @PutMapping("/restaurants/{id}")
    Restaurant replaceRestaurant(@RequestBody Restaurant updatedRestaurant,
